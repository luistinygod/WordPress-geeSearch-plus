...
class Gee_Search_Plus_admin {
	...
	function admin_print_styles() {
		...
		wp_enqueue_style( 'gsp-admin-css', GEE_SP_URL . 'inc/css/admin.css' );
	}
	...
	function render_settings_page() {
		?>
		<div class="wrap">
			<h2>geeSearch Plus, improved WordPress search</h2>
	...
	function register_settings() {
		...
		// Enable
		add_settings_field( 'gee-settings-enable', __( 'Enable geeSearch', 'gee-search-plus' ), array( $this,'settings_checkbox_enable'), 'gee-search-plus', 'gee-settings-section-general', array( 'name' => 'gee_searchplus_options[enable]', 'value' => $options ) );

		// Enable search on taxonomies
		add_settings_field( 'gee-settings-enable-tax', __( 'Search on Taxonomies', 'gee-search-plus' ), array( $this,'settings_checkbox'), 'gee-search-plus', 'gee-settings-section-general', array( 'name' => 'gee_searchplus_options[enable_tax]', 'key' => 'enable_tax', 'value' => $options ) );

		// Enable search on custom fields
		add_settings_field( 'gee-settings-customfields', __( 'Search on Custom Fields', 'gee-search-plus' ), array( $this,'settings_checkbox'), 'gee-search-plus', 'gee-settings-section-general', array( 'name' => 'gee_searchplus_options[custom_fields]', 'key' => 'custom_fields', 'value' => $options ) );

		// Enable search Media
		add_settings_field( 'gee-settings-media', __( 'Search on Media', 'gee-search-plus' ), array( $this,'settings_checkbox'), 'gee-search-plus', 'gee-settings-section-general', array( 'name' => 'gee_searchplus_options[enable_media]', 'key' => 'enable_media', 'value' => $options ) );
